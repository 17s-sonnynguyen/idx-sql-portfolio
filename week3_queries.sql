...
LIMIT 20; -- Limit to certain number
...
FROM rets_property
WHERE AVG(L_SystemPrice) > 600000 -- This happens after aggregation, so this filter should stay within having rather than where
